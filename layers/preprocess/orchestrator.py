...
def run_preprocessing(results_file: str | None = None) -> PreprocessStats:
    ...
    stats.quality_dropped = stats.input_total - stats.quality_passed - quality.stats.duplicate_in_batch
    ...
    score_by_key = {
        (post["post_id"], post["platform"]): score for post, score in scored
    }
